<?php
/**
 * File, which handles the Backplaze S3 support as own protocol.
 *
...
class Protocol extends Protocol_Base {
	...
	public function get_title(): string {
		return BackplazeS3::get_instance()->get_label(); // @phpstan-ignore method.notFound
	}
	...
	public function is_url_compatible(): bool {
		...
		return str_contains( $this->get_url(), 'backblazeb2.com' );
	}
	...
	protected function get_directory_listing_object(): Platform_Base|false {
		return BackplazeS3::get_instance();
	}
	...
	protected function get_key_of_file( string $url ): string {
		...
		// return the key.
		return str_replace( 'https://' . $fields['bucket']['value'] . '.s3.' . $fields['region']['value'] . '.backblazeb2.com/', '', $url );
	}
}
